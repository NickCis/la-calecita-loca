...
public:
	 ...
	 */
	void crear(const std::string& archivo, const char letra ='a');
	 ...
	 * @param archivo: path del archivo a utilizar
	 * @param letra: letra a utilizar
	 * @see MemoriaCompartida::crear
	 */
	MemoriaCompartida(const std::string& archivo, const char letra='a');
...
template <class T> void MemoriaCompartida<T>::leer (T* ptr) const {
